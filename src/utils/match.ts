//匹配有没有中文
export const regZh = (str: string) => {
  return RegExp(/[\u4e00-\u9fa5]+/).test(str);
};

//只允许中文
export const regOnlyZh = (str: string) => {
  return RegExp(/^[\u4e00-\u9fa5]+$/).test(str);
};

//只允许中文，英文字母，数字
export const regZhEnNum = (str: string) => {
  return RegExp(/^[\u4e00-\u9fa5A-Za-z0-9]+$/).test(str);
};

//匹配身份证
export const regIDC = (str: string) => {
...
//匹配邮箱格式
export const regEmail = (str: string) => {
...
export const regPwd = (str: string) => {
  return RegExp(/^[a-zA-Z]\w{5,17}$/).test(str);
};

//日期格式  2019-01-12
export const regDate = (str: string) => {
  return RegExp(/^\d{4}-\d{1,2}-\d{1,2}/).test(str);
};

//匹配空白行
export const regWhiteLine = (str: string) => {
  return RegExp(/\n\s*\r/).test(str);
};

//匹配正数、负数、和小数
export const regNum1 = (str: string) => {
  return RegExp(/^(\-|\+)?\d+(\.\d+)?$/).test(str);
};

//匹配零和非零开头的数字
export const regNum2 = (str: string) => {
  return RegExp(/^(0|[1-9][0-9]*)$/).test(str);
};

//匹配数字
export const regNum3 = (str: string) => {
  return RegExp(/^[0-9]*$/).test(str);
};

//匹配m-n位的数字
export const regNum4 = (str: string) => {
  return RegExp(/^\d{m,n}$/).test(str);
};

//长度为3-20的所有字符
export const allByte = (str: string) => {
  return RegExp(/^.{3,20}$/).test(str);
};

//匹配9-10位的数字
export const groupNum = (str: string) => {
